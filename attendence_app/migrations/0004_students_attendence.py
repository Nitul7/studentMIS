...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('attendence_app', '0003_delete_attendence_delete_students'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_name', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='student_username', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
